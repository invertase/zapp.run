...
Zapp! is an online Flutter sandbox environment running directly in the browser (no remote builds). The purpose of Zapp! 
is to enable developers to quickly prototype Flutter applications without the requirement of a local environment.

...
This will display the embedded preview, taking up the maximum width and height of the parent element.
...
By default, the editor theme (light or dark) will use the user's preference (if set) or the default theme operating system.
